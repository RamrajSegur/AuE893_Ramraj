...
void move1Goal(turtlesim::Pose  goal_pose, double distance_tolerance);
void move2Goal(turtlesim::Pose  goal_pose, double distance_tolerance);
void move3Goal(turtlesim::Pose  goal_pose, double distance_tolerance);
void move4Goal(turtlesim::Pose  goal_pose, double distance_tolerance);
void gridClean();
void spiralClean();
...
int main(int argc, char **argv)
{
    ...
    pose.x=j;
    pose.y=i;
    pose.theta=degrees2radians(180);
    move3Goal(pose, 0.01);
    ...
    pose.x=j;
    pose.y=j+1;
    pose.theta=degrees2radians(270);
    move4Goal(pose, 0.01);

    setDesiredOrientation(degrees2radians(360));
...
void moveGoal(turtlesim::Pose  goal_pose, double distance_tolerance){
    ...
    do{
        ...
        vel_msg.angular.x = 0;
        vel_msg.angular.y = 0;
        /*if(goal_pose.x-turtlesim_pose.x<0)
        {
        vel_msg.angular.z =4*(turtlesim_pose.theta-atan2(goal_pose.y-turtlesim_pose.y, goal_pose.x-turtlesim_pose.x)-turtlesim_pose.theta);
        }*/
...
void move1Goal(turtlesim::Pose  goal_pose, double distance_tolerance){
    ...
    do{
        ...
        vel_msg.angular.z =4*(0-turtlesim_pose.theta);
        velocity_publisher.publish(vel_msg);

        ros::spinOnce();
        loop_rate.sleep();

    }while(turtlesim_pose.x<goal_pose.x);;
    cout<<"end move goal"<<endl;
    vel_msg.linear.x =0;
    vel_msg.angular.z = 0;
    velocity_publisher.publish(vel_msg);
...
void move2Goal(turtlesim::Pose  goal_pose, double distance_tolerance){
    ...
    do{
        ...
        vel_msg.angular.z =4*(PI/2.0-turtlesim_pose.theta);
        velocity_publisher.publish(vel_msg);
        ros::spinOnce();
        loop_rate.sleep();

    }while(turtlesim_pose.y<goal_pose.y);
    cout<<"end move goal"<<endl;
    vel_msg.linear.x =0;
    vel_msg.angular.z = 0;
    velocity_publisher.publish(vel_msg);
...
void move3Goal(turtlesim::Pose  goal_pose, double distance_tolerance){
    ...
    do{
        ...
        vel_msg.angular.z =4*(PI-turtlesim_pose.theta);
        velocity_publisher.publish(vel_msg);
        ros::spinOnce();
        loop_rate.sleep();
...
void move4Goal(turtlesim::Pose  goal_pose, double distance_tolerance){
    ...
    do{
        ...
        vel_msg.angular.z =4*(3*PI/2-turtlesim_pose.theta);
        velocity_publisher.publish(vel_msg);
        ros::spinOnce();
        loop_rate.sleep();
